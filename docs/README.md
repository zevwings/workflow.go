...
**核心规范**：
- [代码风格规范](./development/code-style.md) - 格式化、Lint、命名约定
- [错误处理规范](./development/error-handling.md) - color-eyre、上下文信息
- [命名规范](./development/naming.md) - 文件、函数、结构体、常量、CLI 参数
- [模块组织规范](./development/module-organization.md) - 目录结构、模块职责

**流程规范**：
- [Git 工作流规范](./development/git-workflow.md) - 分支策略、工作流程
- [提交规范](./development/commit.md) - Conventional Commits 格式
- [代码审查规范](./development/code-review.md) - 审查清单、审查重点

**参考文档**：
- [日志和调试规范](./development/references/logging.md) - 日志系统架构、敏感信息过滤
- [文档规范](./development/references/documentation.md) - 公共 API 文档、文档同步要求
- [配置管理规范](./development/references/configuration.md) - 配置验证、配置迁移
- [安全性规则](./development/references/security.md) - API Token 处理、输入验证
- [依赖管理规范](./development/references/dependency-management.md) - 添加依赖、依赖更新

**开发工作流**：
- [开发工作流索引](./development/workflows/README.md) - 新功能开发、重构、添加依赖等流程

**快速导航**：
- [开发规范索引](./development/README.md) - 开发规范总览和快速导航
...
### [document.md](./guidelines/document.md) - 文档时间戳维护
**文档编写指南**（包含文档时间戳维护章节）
...
> AI 工作流指南位于 [`workflows/`](./development/workflows/) 目录下

### [工作流指南索引](./development/workflows/README.md)
**AI 工作流完整指南**
...
### [pre-commit.md](./development/workflows/pre-commit.md)
**提交前检查指南（5-15分钟）**
...
### [review.md](./development/workflows/review.md)
**综合深入检查指南（2-4小时）**
...
### [quick-reference.md](./development/references/quick-reference.md)
**快速参考指南**
...
### [style.md](./development/references/style.md)
**样式规范指南**
...
### [review-document-completeness.md](./development/references/review-document-completeness.md)
**文档检查指南**
...
### [review-test-case.md](./development/references/review-test-case.md)
**测试用例检查指南**
...
### [review-code.md](./development/references/review-code.md)
**代码检查指南**
